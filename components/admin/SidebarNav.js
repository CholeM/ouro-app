...
export default function SidebarNav() {
  return (
    <ul className="list-unstyled">
      <SidebarNavItem icon={faHome} href="/client">
        Dashboard
      </SidebarNavItem>
      <SidebarNavItem icon={faUser} href="/client/profile">
        Profile
      </SidebarNavItem>
      <SidebarNavItem icon={faDownload} href="/client/downloads">
        My Downloads
      </SidebarNavItem>
      <SidebarNavItem icon={faUpload} href="/client/uploads">
        My Uploads
      </SidebarNavItem>
      <SidebarNavItem icon={faBox} href="/client/products">
       My Products
      </SidebarNavItem>
    </ul>
  )
